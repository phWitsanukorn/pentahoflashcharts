...
//    PentahoOFC4JHelper helper = new PentahoOFC4JHelper(chartNode, rs, false, null);
...
//    
//    Assert.assertEquals(json, c2.toString());
...
//    System.out.println(json.replaceAll("\"", "\\\\\""));
  ...
  public void testBogusData() {
    ...
    try {
      ...
      Assert.assertTrue(e.getMessage().toLowerCase().indexOf("invalid") >= 0);
    }
  }
